  ...
  return (
    ...
    <nav className="bg-amber-500 text-white p-5 flex h-17 fixed  top-0 left-0 right-0 w-full z-50">
        ...
        <div id="nav-logo" className="left-0 mr-30 ml-15"> 
            <Link to="/admin"><img src={inventoryLogo} alt="Inventory Logo" className="h-6 mt-1 scale-500 hover:scale-475   cursor-pointer " /></Link>
        </div>
        
        <div id="nav-links">
            <ul className="flex gap-15 mt-1 text-[18px] font-bold text-gray-600">
                <li><Link to="/admin/home" className="block hover:text-indigo-700 hover:scale-110 transition-all duration-200">Home</Link></li>
                <li><Link to="/admin/products" className="block hover:text-indigo-700 hover:scale-110 transition-all duration-200">Products</Link></li>
                <li><Link to="/admin/inventory" className="block hover:text-indigo-700 hover:scale-110 transition-all duration-200">Inventory</Link></li>
                <li><Link to="/admin/history" className="block hover:text-indigo-700 hover:scale-110 transition-all duration-200">History</Link></li>
                <li><Link to="/admin/admin" className="block hover:text-indigo-700 hover:scale-110 transition-all duration-200">Admin</Link></li>
            </ul>            
        </div>
        ...
        <div id="nav-user" className="right-0 ml-10 mr-5 relative">
          <div className="cursor-pointer relative">
            ...
            <div id="user-dropdown" className="absolute -right-10 top-full font-semibold mt-4 w-32 text-center bg-amber-600 rounded-md shadow-lg hidden z-50">
              <ul>
